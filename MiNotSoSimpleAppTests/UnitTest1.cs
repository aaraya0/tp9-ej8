...
namespace MiNotSoSimpleAppTests
{
    public class ApiServiceTests
    {
        ...
        public async Task GetMyModelsAsync_ReturnsDataFromHttpClient()
        {
            ...
            {
                Content = new StringContent("[{ \"UserId\": 1, \"Id\": 1, \"Title\": \"Test Title\", \"Body\": \"Test Body 1\" },{ \"UserId\": 2, \"Id\": 2, \"Title\": \"Test Title\", \"Body\": \"Test Body 2\" },{ \"UserId\": 3, \"Id\": 3, \"Title\": \"Test Title\", \"Body\": \"Test Body 3\" },{ \"UserId\": 4, \"Id\": 4, \"Title\": \"Test Title\", \"Body\": \"Test Body 4\" }]")
            };
